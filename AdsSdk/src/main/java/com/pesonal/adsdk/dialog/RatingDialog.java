...
public class RatingDialog extends AppCompatDialog implements RatingBar.OnRatingBarChangeListener, View.OnClickListener {
        ...
        if (builder.ratingBarColor != 0) {
            {
                ...
                int ratingBarBackgroundColor = builder.ratingBarBackgroundColor != 0 ? builder.ratingBarBackgroundColor : R.color.colorVpnDeActive;
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.dialog_rating_button_negative) {
            ...
            dismiss();
            showNever();
            if(builder.dialogCloseListener!=null)
                builder.dialogCloseListener.onClose(0);
            ...
            if (builder.ratingDialogFormListener != null) {
                builder.ratingDialogFormListener.onFormSubmitted(feedback, (int) ratingBar.getRating());
            }
            ...
            if(builder.dialogCloseListener!=null) {
                builder.dialogCloseListener.onClose((int) ratingBar.getRating());
            }
            dismiss();
    ...
    private void setRatingThresholdClearedListener() {
        builder.ratingThresholdClearedListener = new Builder.RatingThresholdClearedListener() {
            ...
            public void onThresholdCleared(RatingDialog ratingDialog, float rating, boolean thresholdCleared) {
                ...
                dismiss();
                if(builder.dialogCloseListener!=null)
                    builder.dialogCloseListener.onClose(5);
            }
        };
    }
    ...
    public static class Builder {
        ...
        public interface RatingDialogFormListener {
            void onFormSubmitted(String feedback,int rate);
        }
        ...
        public Builder onDialogList(DialogCloseListener ratingDialogListener) {
            this.dialogCloseListener = ratingDialogListener;
            return this;
        }
